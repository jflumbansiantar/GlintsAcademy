...
router.post('/add', authentication, authorization, uploader.single('picture'), MovieController.addMovie)
router.get('/find/title', MovieController.search)
router.get('/find/:id', authentication, MovieController.findById)
router.put('/update/:id', authentication, authorization, uploader.single('picture'), MovieController.updateMovie)
